#ifndef UE4SS_SDK_BP_BuildObject_ItemChest_04_HPP
#define UE4SS_SDK_BP_BuildObject_ItemChest_04_HPP

class ABP_BuildObject_ItemChest_04_C : public APalBuildObject
{
    ...
    class UBoxComponent* CheckOverlapCollision;                                       // 0x0760 (size: 0x8)
