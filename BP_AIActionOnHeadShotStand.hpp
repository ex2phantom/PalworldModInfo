...
class UBP_AIActionOnHeadShotStand_C : public UPalAIActionBase
{
    ...
    class UPalAnimInstance* PlayerABP;                                                // 0x0140 (size: 0x8)
    class APalCharacter* PlayerCharacter;                                             // 0x0148 (size: 0x8)
    class APalCharacter* OwnerCharacter;                                              // 0x0150 (size: 0x8)
    class UBP_CoopParam_OnHeadShot_C* CoopParam;                                      // 0x0158 (size: 0x8)
    bool IsAimMode;                                                                   // 0x0160 (size: 0x1)
    class UPalShooterComponent* ShooterCP;                                            // 0x0168 (size: 0x8)
    class UPalPartnerSkillParameterComponent* PartnerSkillParam;                      // 0x0170 (size: 0x8)
    bool IsAborted;                                                                   // 0x0178 (size: 0x1)
    class UPalActionComponent* ActionComponent;                                       // 0x0180 (size: 0x8)
