#ifndef UE4SS_SDK_BP_BuildObject_Zabuton_HPP
#define UE4SS_SDK_BP_BuildObject_Zabuton_HPP

class ABP_BuildObject_Zabuton_C : public APalBuildObject
{
    class UBP_BuildObjectSimulateArrowComponent_C* BP_BuildObjectSimulateArrowComponent; // 0x0750 (size: 0x8)
    class UPalMapObjectPlayerSitLocationComponent* PalMapObjectPlayerSitLocation;     // 0x0758 (size: 0x8)
    class UStaticMeshComponent* SM_Rectangular_Table;                                 // 0x0760 (size: 0x8)
