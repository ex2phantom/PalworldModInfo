#ifndef UE4SS_SDK_BP_EnemyCampObject_Metal_DoorWall_HPP
#define UE4SS_SDK_BP_EnemyCampObject_Metal_DoorWall_HPP

class ABP_EnemyCampObject_Metal_DoorWall_C : public APalBuildObjectBasicBase
{
    ...
    float _______RotateDoor_8642197E4D28B9D21EE6C5AEA229AA24;                         // 0x07F0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ________Direction_8642197E4D28B9D21EE6C5AEA229AA24; // 0x07F4 (size: 0x1)
    ...
    void ExecuteUbergraph_BP_EnemyCampObject_Metal_DoorWall(int32 EntryPoint);
}; // Size: 0x800
