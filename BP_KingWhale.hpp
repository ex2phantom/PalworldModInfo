#ifndef UE4SS_SDK_BP_KingWhale_HPP
#define UE4SS_SDK_BP_KingWhale_HPP

class ABP_KingWhale_C : public ABP_MonsterBase_C
{
    ...
    class USphereComponent* Sphere;                                                   // 0x0D90 (size: 0x8)
