...
{
    class UPalShooterComponent* PalShooter;                                           // 0x0D30 (size: 0x8)
    class UPalSpeedCollisionComponent* PalSpeedCollision;                             // 0x0D38 (size: 0x8)
    class UPalBodyPartsSphereComponent* PalBodyPartsSphere3;                          // 0x0D40 (size: 0x8)
    class UPalBodyPartsSphereComponent* PalBodyPartsSphere2;                          // 0x0D48 (size: 0x8)
    ...
    class UNiagaraComponent* WingEffect;                                              // 0x0D78 (size: 0x8)
    class UPalFlyMeshHeightCtrlComponent* PalFlyMeshHeightCtrl;                       // 0x0D80 (size: 0x8)
    class UPalRideMarkerComponent* PalRideMarker;                                     // 0x0D88 (size: 0x8)
