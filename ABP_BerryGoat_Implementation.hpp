...
class UABP_BerryGoat_Implementation_C : public UAnimInstance
{
    ...
    FAnimNode_Root AnimGraphNode_Root_2;                                              // 0x0F28 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose_2;                        // 0x0F48 (size: 0xC8)
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x1010 (size: 0x250)
    FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;       // 0x1260 (size: 0x20)
    FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;       // 0x1280 (size: 0x20)
    FAnimNode_Root AnimGraphNode_Root_1;                                              // 0x12A0 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose_1;                        // 0x12C0 (size: 0xC8)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose;                          // 0x1388 (size: 0xC8)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x1450 (size: 0x20)
    double __CustomProperty_PositionAlpha_leg_back_04_r_Goal_8A6A9BC04289B91DD13993887B2C7D80; // 0x1470 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_back_04_l_Goal_8A6A9BC04289B91DD13993887B2C7D80; // 0x1478 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_front_04_r_Goal_8A6A9BC04289B91DD13993887B2C7D80; // 0x1480 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_front_04_l_Goal_8A6A9BC04289B91DD13993887B2C7D80; // 0x1488 (size: 0x8)
