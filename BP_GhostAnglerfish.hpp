#ifndef UE4SS_SDK_BP_GhostAnglerfish_HPP
#define UE4SS_SDK_BP_GhostAnglerfish_HPP

class ABP_GhostAnglerfish_C : public ABP_MonsterBase_C
{
    ...
    class UPalFlyMeshHeightCtrlComponent* PalFlyMeshHeightCtrl;                       // 0x0D40 (size: 0x8)
