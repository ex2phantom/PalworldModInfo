#ifndef UE4SS_SDK_ABP_NightBlueHorse_Implementation_HPP
#define UE4SS_SDK_ABP_NightBlueHorse_Implementation_HPP
...
class UABP_NightBlueHorse_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_Root AnimGraphNode_Root_1;                                              // 0x1630 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose_1;                        // 0x1650 (size: 0xC8)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose;                          // 0x1718 (size: 0xC8)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x17E0 (size: 0x20)
    double __CustomProperty_PositionAlpha_leg_back_04_r_Goal_D35D5D9A4667930E05D0A3BEEEBB44A7; // 0x1800 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_back_04_l_Goal_D35D5D9A4667930E05D0A3BEEEBB44A7; // 0x1808 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_front_04_r_Goal_D35D5D9A4667930E05D0A3BEEEBB44A7; // 0x1810 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_front_04_l_Goal_D35D5D9A4667930E05D0A3BEEEBB44A7; // 0x1818 (size: 0x8)
    FVector LookAtWorldLocation;                                                      // 0x1820 (size: 0x18)
    ...
    void ExecuteUbergraph_ABP_NightBlueHorse_Implementation(int32 EntryPoint);
}; // Size: 0x1838
