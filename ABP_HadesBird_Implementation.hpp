...
class UABP_HadesBird_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_1;                                          // 0x0FC0 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x1210 (size: 0x250)
    FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;       // 0x1460 (size: 0x20)
