...
class UWBP_InventoryEquipment_StatusBuffTimer_C : public UUserWidget
{
    ...
    TEnumAsByte<E_PalFoodStatusForStatusBuffTimer::Type> BuffType;                    // 0x03A1 (size: 0x1)

    void SetFoodBuff(TEnumAsByte<E_PalFoodStatusForStatusBuffTimer::Type> BuffType, TEnumAsByte<E_PalFoodStatusForStatusBuffTimer::Type> BuffTypeForStatusBuffTimer, bool IsBuff, class UPalIndividualCharacterParameter* IndividualParam);
    void Destruct();
