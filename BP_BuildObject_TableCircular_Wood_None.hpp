#ifndef UE4SS_SDK_BP_BuildObject_TableCircular_Wood_None_HPP
#define UE4SS_SDK_BP_BuildObject_TableCircular_Wood_None_HPP

class ABP_BuildObject_TableCircular_Wood_None_C : public APalBuildObject
{
    class UBP_BuildObjectSimulateArrowComponent_C* BP_BuildObjectSimulateArrowComponent; // 0x0750 (size: 0x8)
    class UStaticMeshComponent* SM_circular_table;                                    // 0x0758 (size: 0x8)
    class USceneComponent* Meshs;                                                     // 0x0760 (size: 0x8)
