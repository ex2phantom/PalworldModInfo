#ifndef UE4SS_SDK_BP_MushroomLady_HPP
#define UE4SS_SDK_BP_MushroomLady_HPP

class ABP_MushroomLady_C : public ABP_MonsterBase_C
{
    class UPalBodyPartsCapsuleComponent* PalBodyPartsCapsule2;                        // 0x0D30 (size: 0x8)
