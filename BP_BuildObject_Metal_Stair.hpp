#ifndef UE4SS_SDK_BP_BuildObject_Metal_Stair_HPP
#define UE4SS_SDK_BP_BuildObject_Metal_Stair_HPP

class ABP_BuildObject_Metal_Stair_C : public APalBuildObjectBasicBase
{
    class UBP_InteractableBox_C* BP_InteractableBox;                                  // 0x0780 (size: 0x8)
    class UStaticMeshComponent* SM_Stair_Iron;                                        // 0x0788 (size: 0x8)
