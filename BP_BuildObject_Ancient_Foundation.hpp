#ifndef UE4SS_SDK_BP_BuildObject_Ancient_Foundation_HPP
#define UE4SS_SDK_BP_BuildObject_Ancient_Foundation_HPP

class ABP_BuildObject_Ancient_Foundation_C : public APalBuildObjectBasicBase
{
    class UBP_InteractableBox_C* BP_InteractableBox;                                  // 0x0780 (size: 0x8)
    class UBoxComponent* BuildWorkableBounds;                                         // 0x0788 (size: 0x8)
    class UStaticMeshComponent* SM_Floor_Wood;                                        // 0x0790 (size: 0x8)
