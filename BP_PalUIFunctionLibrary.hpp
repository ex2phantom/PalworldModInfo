...
class UBP_PalUIFunctionLibrary_C : public UBlueprintFunctionLibrary
{
    ...
    void FormatBaseCampBuildingTaskMsg(TArray<FPalDataTableRowName_MapObjectData>& BuildObjectIdArray, class UObject* __WorldContext, FText& OutText);
    void GetSuitabilityDescription(EPalWorkSuitability Suitability, class UObject* __WorldContext, FText& DescriptionText);
