...
class UABP_GrassPanda_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace_1;     // 0x0D90 (size: 0x20)
    FAnimNode_ModifyBone AnimGraphNode_ModifyBone_1;                                  // 0x0DB0 (size: 0x128)
    FAnimNode_ModifyBone AnimGraphNode_ModifyBone;                                    // 0x0ED8 (size: 0x128)
    ...
    FRotator AimRotator;                                                              // 0x1570 (size: 0x18)
    FVector LookAtWorldLocation;                                                      // 0x1588 (size: 0x18)
