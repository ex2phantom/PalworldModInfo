...
class UBP_Action_Unique_DrillGame_ShellAttack_C : public UBP_ActionUniqueAttackBase_C
{
    ...
    class UAnimMontage* Montage_Start;                                                // 0x02A0 (size: 0x8)
    class UAnimMontage* Montage_Loop;                                                 // 0x02A8 (size: 0x8)
    class UAnimMontage* Montage_End;                                                  // 0x02B0 (size: 0x8)
    double Const_LoopTime;                                                            // 0x02B8 (size: 0x8)
    double Const_MoveSpeed;                                                           // 0x02C0 (size: 0x8)
    bool IsMoving;                                                                    // 0x02C8 (size: 0x1)
    class ABP_SkillEffect_Drillgame_SpiningShell_C* EffectActor;                      // 0x02D0 (size: 0x8)
    bool IsStopedEffect;                                                              // 0x02D8 (size: 0x1)
