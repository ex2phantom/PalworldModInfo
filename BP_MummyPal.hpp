#ifndef UE4SS_SDK_BP_MummyPal_HPP
#define UE4SS_SDK_BP_MummyPal_HPP

class ABP_MummyPal_C : public ABP_MonsterBase_C
{
    class UPalBodyPartsCapsuleComponent* PalBodyPartsCapsule8;                        // 0x0D30 (size: 0x8)
