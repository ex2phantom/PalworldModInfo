#ifndef UE4SS_SDK_ABP_WhiteDeer_Implementation_HPP
#define UE4SS_SDK_ABP_WhiteDeer_Implementation_HPP
...
class UABP_WhiteDeer_Implementation_C : public UPalAnimInstance
{
    ...
    double __CustomProperty_PositionAlpha_leg_front_04_l_Goal_727539C04A07B94F1808C4B4001BDA48; // 0x1CA0 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_front_04_r_Goal_727539C04A07B94F1808C4B4001BDA48; // 0x1CA8 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_back_04_l_Goal_727539C04A07B94F1808C4B4001BDA48; // 0x1CB0 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_back_04_r_Goal_727539C04A07B94F1808C4B4001BDA48; // 0x1CB8 (size: 0x8)
    ...
    void ExecuteUbergraph_ABP_WhiteDeer_Implementation(int32 EntryPoint);
}; // Size: 0x1CD8
