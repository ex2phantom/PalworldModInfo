...
class ABP_BuildObject_OlympicCauldron_C : public APalBuildObject
{
    ...
    class UNiagaraComponent* Fire;                                                    // 0x0760 (size: 0x8)
    class UBP_InteractableBox_C* BP_InteractableBox;                                  // 0x0768 (size: 0x8)
    class UPalMapObjectBaseCampPassiveEffectWorkSpeedParameterComponent* BaseCampPassiveEffectWorkSpeedParameter; // 0x0770 (size: 0x8)
