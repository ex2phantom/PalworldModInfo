...
class UABP_Gorilla_Implementation_C : public UAnimInstance
{
    ...
    double __CustomProperty_PositionAlpha_foot_r_Goal_18B87F1B47910EBE382D8DAD96066FA8; // 0x1470 (size: 0x8)
    double __CustomProperty_PositionAlpha_foot_l_Goal_18B87F1B47910EBE382D8DAD96066FA8; // 0x1478 (size: 0x8)
    double __CustomProperty_PositionAlpha_hand_l_Goal_18B87F1B47910EBE382D8DAD96066FA8; // 0x1480 (size: 0x8)
    double __CustomProperty_PositionAlpha_hand_r_Goal_18B87F1B47910EBE382D8DAD96066FA8; // 0x1488 (size: 0x8)
