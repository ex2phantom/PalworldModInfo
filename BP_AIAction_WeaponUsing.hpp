...
class UBP_AIAction_WeaponUsing_C : public UPalAIActionBase
{
    ...
    class AActor* OwnerPawn;                                                          // 0x0140 (size: 0x8)
    class APalCharacter* WeaponUser;                                                  // 0x0148 (size: 0x8)
    class UPalPartnerSkillParameterComponent* PartnerSkillParam;                      // 0x0150 (size: 0x8)
    class UBP_CoopParam_Weapon_C* CoopParam;                                          // 0x0158 (size: 0x8)
    class UPalShooterComponent* Shooter;                                              // 0x0160 (size: 0x8)
    bool IsShooting;                                                                  // 0x0168 (size: 0x1)
    class UPalActionBase* AttachWeaponAction;                                         // 0x0170 (size: 0x8)
