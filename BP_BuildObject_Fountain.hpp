...
class ABP_BuildObject_Fountain_C : public APalBuildObject
{
    ...
    class UNiagaraComponent* NS_Fountain;                                             // 0x0758 (size: 0x8)
    class UBP_InteractableBox_C* BP_InteractableBox;                                  // 0x0760 (size: 0x8)
    class UPalMapObjectBaseCampPassiveEffectWorkSpeedParameterComponent* BaseCampPassiveEffectWorkSpeedParameter; // 0x0768 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x0770 (size: 0x8)
