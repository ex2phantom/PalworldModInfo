...
class UBP_Action_StunBlow_C : public UPalActionBase
{
    ...
    double StunTimeSec;                                                               // 0x0168 (size: 0x8)
    FVector BlowVelocity;                                                             // 0x0170 (size: 0x18)
    FTimerHandle TimerHandle;                                                         // 0x0188 (size: 0x8)
    FTransform DefaultTransform;                                                      // 0x0190 (size: 0x60)
    FName Flag Name;                                                                  // 0x01F0 (size: 0x8)
    bool IsElapsedMinBlowTime;                                                        // 0x01F8 (size: 0x1)
    class UNiagaraComponent* StunEffect;                                              // 0x0200 (size: 0x8)
    FVector PrevLocation;                                                             // 0x0208 (size: 0x18)
    double MaxStunTimeSec;                                                            // 0x0220 (size: 0x8)
    double ElapsedTime;                                                               // 0x0228 (size: 0x8)
    FBP_Action_StunBlow_CNewEventDispatcher_0 NewEventDispatcher_0;                   // 0x0230 (size: 0x10)
    void NewEventDispatcher_0();
    bool IsSpawnEffect;                                                               // 0x0240 (size: 0x1)
