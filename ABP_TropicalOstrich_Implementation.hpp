#ifndef UE4SS_SDK_ABP_TropicalOstrich_Implementation_HPP
#define UE4SS_SDK_ABP_TropicalOstrich_Implementation_HPP
...
class UABP_TropicalOstrich_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_1;                                          // 0x0D50 (size: 0x250)
    ...
    FAnimNode_Root AnimGraphNode_Root_1;                                              // 0x1230 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose_1;                        // 0x1250 (size: 0xC8)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose;                          // 0x1318 (size: 0xC8)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x13E0 (size: 0x20)
    FVector LookAtWorldLocation;                                                      // 0x1400 (size: 0x18)
    ...
    void ExecuteUbergraph_ABP_TropicalOstrich_Implementation(int32 EntryPoint);
}; // Size: 0x1418
