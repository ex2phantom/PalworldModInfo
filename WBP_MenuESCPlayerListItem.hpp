...
class UWBP_MenuESCPlayerListItem_C : public UUserWidget
{
    ...
    FWBP_MenuESCPlayerListItem_COnHovered OnHovered;                                  // 0x0338 (size: 0x10)
    ...
    FWBP_MenuESCPlayerListItem_COnRightClicked OnRightClicked;                        // 0x0380 (size: 0x10)
    void OnRightClicked(class UWBP_MenuESCPlayerListItem_C* buttonBase);
    FString Display Player Name;                                                      // 0x0390 (size: 0x10)
    bool IsSamePlatform;                                                              // 0x03A0 (size: 0x1)
