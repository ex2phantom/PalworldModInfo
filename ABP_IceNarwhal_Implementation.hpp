#ifndef UE4SS_SDK_ABP_IceNarwhal_Implementation_HPP
#define UE4SS_SDK_ABP_IceNarwhal_Implementation_HPP
...
class UABP_IceNarwhal_Implementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_IceNarwhal_Implementation(int32 EntryPoint);
}; // Size: 0x11C8
