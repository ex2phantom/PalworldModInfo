...
class ABP_BuildObject_Cauldron_C : public APalBuildObject
{
    ...
    class UNiagaraComponent* NS_Caldron;                                              // 0x0760 (size: 0x8)
    class UStaticMeshComponent* SM_Caldron;                                           // 0x0768 (size: 0x8)
    class UBP_InteractableBox_C* BP_InteractableBox;                                  // 0x0770 (size: 0x8)
    class UPalMapObjectBaseCampPassiveEffectWorkSpeedParameterComponent* BaseCampPassiveEffectWorkSpeedParameter; // 0x0778 (size: 0x8)
