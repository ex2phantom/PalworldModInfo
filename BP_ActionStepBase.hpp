...
class UBP_ActionStepBase_C : public UPalActionBase
{
    ...
    double StepTime;                                                                  // 0x0170 (size: 0x8)
    class UCurveFloat* StepCurve;                                                     // 0x0178 (size: 0x8)
    double Timer;                                                                     // 0x0180 (size: 0x8)
    EPalGeneralMontageType StepType;                                                  // 0x0188 (size: 0x1)
    bool CanEndStep;                                                                  // 0x0189 (size: 0x1)
    class UAnimMontage* Montage;                                                      // 0x0190 (size: 0x8)
    bool CanCrouchCancel;                                                             // 0x0198 (size: 0x1)
    double CrouchCancelTime;                                                          // 0x01A0 (size: 0x8)
    class UCurveFloat* StepCurve_Location;                                            // 0x01A8 (size: 0x8)
    FVector StartLocation;                                                            // 0x01B0 (size: 0x18)
    FVector MoveDIrection;                                                            // 0x01C8 (size: 0x18)
    ...
    EPalTraceTypeQuery Const_TraceChannel_Before;                                     // 0x0220 (size: 0x1)
    EPalTraceTypeQuery Const_TraceChannel;                                            // 0x0221 (size: 0x1)
    TEnumAsByte<EDrawDebugTrace::Type> Const_DrawDebugType;                           // 0x0222 (size: 0x1)
    double CapsuleHeightHalf_Max;                                                     // 0x0228 (size: 0x8)
    double CapsuleHeightHalf_Min;                                                     // 0x0230 (size: 0x8)
    double Timer_forCapsule;                                                          // 0x0238 (size: 0x8)
    double ActionTimer;                                                               // 0x0240 (size: 0x8)
    bool IsShootDisable;                                                              // 0x0248 (size: 0x1)
