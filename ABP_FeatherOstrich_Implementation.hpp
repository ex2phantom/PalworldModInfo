...
class UABP_FeatherOstrich_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_4;                                          // 0x0D50 (size: 0x250)
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_3;                                          // 0x0FE0 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt_2;                                          // 0x1230 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt_1;                                          // 0x1480 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x16D0 (size: 0x250)
    FAnimNode_Root AnimGraphNode_Root_1;                                              // 0x1920 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose_1;                        // 0x1940 (size: 0xC8)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose;                          // 0x1A08 (size: 0xC8)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x1AD0 (size: 0x20)
    FVector LookAtWorldLocation;                                                      // 0x1AF0 (size: 0x18)
