#ifndef UE4SS_SDK_BP_BuildObject_Metal_Wall_V2_HPP
#define UE4SS_SDK_BP_BuildObject_Metal_Wall_V2_HPP

class ABP_BuildObject_Metal_Wall_V2_C : public APalBuildObjectBasicBase
{
    ...
    class UStaticMeshComponent* SM_Wall_Iron;                                         // 0x0798 (size: 0x8)
