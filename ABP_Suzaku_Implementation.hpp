...
class UABP_Suzaku_Implementation_C : public UAnimInstance
{
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_2;                                          // 0x0B70 (size: 0x250)
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_1;                                          // 0x0E00 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x1050 (size: 0x250)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x12A0 (size: 0x20)
    FVector LookAtWorldLocation;                                                      // 0x12C0 (size: 0x18)
