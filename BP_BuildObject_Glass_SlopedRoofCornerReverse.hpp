#ifndef UE4SS_SDK_BP_BuildObject_Glass_SlopedRoofCornerReverse_HPP
#define UE4SS_SDK_BP_BuildObject_Glass_SlopedRoofCornerReverse_HPP

class ABP_BuildObject_Glass_SlopedRoofCornerReverse_C : public APalBuildObjectBasicBase
{
    class UStaticMeshComponent* SM_Stair_Wood1;                                       // 0x0780 (size: 0x8)
