...
class UABP_VolcanicMonster_Implementation_C : public UPalAnimInstance
{
    ...
    double __CustomProperty_PositionAlpha_leg_front_03_l_Goal_6EE499CC48EA7E1D089199AC7AC5A0F7; // 0x1CA0 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_front_03_r_Goal_6EE499CC48EA7E1D089199AC7AC5A0F7; // 0x1CA8 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_back_04_l_Goal_6EE499CC48EA7E1D089199AC7AC5A0F7; // 0x1CB0 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_back_04_r_Goal_6EE499CC48EA7E1D089199AC7AC5A0F7; // 0x1CB8 (size: 0x8)
