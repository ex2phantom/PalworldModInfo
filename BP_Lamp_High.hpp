#ifndef UE4SS_SDK_BP_Lamp_High_HPP
#define UE4SS_SDK_BP_Lamp_High_HPP

class ABP_Lamp_High_C : public ABP_LampBase_C
{
    ...
    void ExecuteUbergraph_BP_Lamp_High(int32 EntryPoint);
}; // Size: 0x320
