#ifndef UE4SS_SDK_BP_IceSeal_HPP
#define UE4SS_SDK_BP_IceSeal_HPP

class ABP_IceSeal_C : public ABP_MonsterBase_C
{
    class UPalBodyPartsSphereComponent* PalBodyPartsSphere;                           // 0x0D30 (size: 0x8)
    class UBP_PalRideMarkerBiggerHorse_C* BP_PalRideMarkerBiggerHorse;                // 0x0D38 (size: 0x8)
