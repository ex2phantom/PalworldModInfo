#ifndef UE4SS_SDK_BP_BuildObject_Glass_DoorWall_HPP
#define UE4SS_SDK_BP_BuildObject_Glass_DoorWall_HPP

class ABP_BuildObject_Glass_DoorWall_C : public APalBuildObjectBasicBase
{
    ...
    float _______RotateDoor_98AB515549034FA59C47E8977F2A4523;                         // 0x07F0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ________Direction_98AB515549034FA59C47E8977F2A4523; // 0x07F4 (size: 0x1)
