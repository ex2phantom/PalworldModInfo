#ifndef UE4SS_SDK_BP_BuildObject_Glass_TriangleStairsCorner_HPP
#define UE4SS_SDK_BP_BuildObject_Glass_TriangleStairsCorner_HPP

class ABP_BuildObject_Glass_TriangleStairsCorner_C : public APalBuildObjectBasicBase
{
    class UBP_InteractableBox_C* BP_InteractableBox;                                  // 0x0780 (size: 0x8)
    class UStaticMeshComponent* SM_Stair_Wood;                                        // 0x0788 (size: 0x8)
