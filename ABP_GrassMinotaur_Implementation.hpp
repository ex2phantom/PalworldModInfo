#ifndef UE4SS_SDK_ABP_GrassMinotaur_Implementation_HPP
#define UE4SS_SDK_ABP_GrassMinotaur_Implementation_HPP
...
class UABP_GrassMinotaur_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_2;                                          // 0x0D50 (size: 0x250)
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_1;                                          // 0x0FE0 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x1230 (size: 0x250)
    FAnimNode_Root AnimGraphNode_Root_1;                                              // 0x1480 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose_1;                        // 0x14A0 (size: 0xC8)
    ...
    FVector LookAtWorldLocation;                                                      // 0x1650 (size: 0x18)
    ...
    void ExecuteUbergraph_ABP_GrassMinotaur_Implementation(int32 EntryPoint);
}; // Size: 0x1668
